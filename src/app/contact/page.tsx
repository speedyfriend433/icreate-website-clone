...
export const metadata: Metadata = {
  title: "iShitPro - Contact & Policies",
  description: "Contact information and policies for iShitPro",
};
    ...
    <div className="bg-darker-gray p-10 text-white text-lg md:text-xl items-center min-h-[70vh]">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <p className="mb-4">
            By using iShitPro, you agree to the following terms:
          </p>
          <ul className="list-disc list-inside ml-4">
            <li>iShitPro is provided "as is" without warranty of any kind</li>
